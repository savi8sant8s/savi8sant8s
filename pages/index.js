            ...
            <Col xs={6}>
              ...
              <Card bg="secondary" border="warning">
                ...
                <p><strong>Graduação: </strong>Técnico em Desenvolvimento de Sistemas e estudante de Bacharelado em Eng. de Software.</p>
                  <p><strong>Tecnologias principais que domino: </strong>Ionic/Angular, Python, SQL, React e Express.</p>
                  <p><strong>Tecnologias que já tive contato: </strong>C, Java, Rust e Haskell.</p>
